...
export class ProductsComponent {
  ...
  public columnDefs: ColDef[] = [
    ...
    { field: 'sku', filter: 'agTextColumnFilter', floatingFilter: true, sortable: true},
    { field: 'price', filter: 'agNumberColumnFilter', floatingFilter: true, sortable: true, valueFormatter: params => `$ ${params.value}`},
    { field: 'description', filter: 'agTextColumnFilter', floatingFilter: true, sortable: true},
